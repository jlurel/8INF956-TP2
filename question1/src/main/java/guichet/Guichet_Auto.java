...
public class Guichet_Auto {
    ...
    public Guichet_Auto( Compte compte ) {
        ...
        this.ecran.setTitle( "Banque INF859, service " +  this.compte.getService() );
        this.setSoldeEcran( compte.getSolde() );
    }
    private void construireEcran() {
        this.ecran = new JFrame();
        ecran.setSize( 550, 460 );
        ...
        //panneauNom.add( new JLabel( "Titulaire du compte: " + this.compte.getNom() +
        // "        Téléphone :" + this.compte.getNumeroTel() ));
